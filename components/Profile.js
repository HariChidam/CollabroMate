...
export default function Profile({email, Firstname, Lastname, Grade, Class, GPA, Bio, Url}) {
  return (
    <div className="bg-white shadow rounded-lg p-6">
      <h1 className="text-2xl font-bold mb-4">{Firstname + " " + Lastname}</h1>
      {/* {Url && <Image src={Url} alt='profile pic'> </Image>} */}
      <Image src={Url} alt='profile pic' width={200} height={200} className="rounded-full mb-4"></Image>
      ...
      <div className="flex items-center">
        <span className="text-gray-600 text-lg font-medium mr-2">Bio:</span>
